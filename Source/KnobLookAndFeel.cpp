    ...
    int, int, int, int, juce::ComboBox& box)
{
    ...
    g.setColour(juce::Colour::fromRGB(210, 206, 192));
...
void KnobLookAndFeel::drawPopupMenuBackground (juce::Graphics& g, [[maybe_unused]] int width, [[maybe_unused]] int height)
{
